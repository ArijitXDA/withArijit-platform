...
export default async function AiMonitorPage() {
  ...
  // ── Days since last Class Monitor visit ────────────────────────────────────
  ...
  function buildWelcome(): string {
    ...
    return `${greeting}, **${firstName}!** 🌟\n\nWelcome to your **oStaran Class Monitor** — your personal AI tutor for the **${courseName}** programme.\n\nI'm here to help you with your schedule, explain any concept from the curriculum, answer questions about your sessions and certificates, and guide you through your AI learning journey.\n\n${!batchId ? '⚠️ **Tip:** Select a batch from your dashboard to see your session schedule here.\n\n' : ''}What would you like to explore first?`
  }
