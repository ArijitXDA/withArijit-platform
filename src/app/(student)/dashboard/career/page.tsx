...
export default async function CareerPage() {
  ...
  // Load the student's current CV path from student_profiles so we can show
  // the right state on first render (view/replace vs upload).
    ...
    <div className="space-y-5 pb-12 max-w-2xl">
      <div>
        ...
        <p className="text-sm mt-0.5" style={{ color: T.textMuted }}>
          AI job opportunities and career resources for oStaran students
        </p>
      </div>
      ...
      <div className="grid gap-4">
        ...
        <div className="rounded-2xl bg-white p-6" style={{ border: `1px solid ${T.border}` }}>
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-sm mb-3" style={{ color: T.textSec }}>
                Explore AI roles from our hiring partner network.
              </p>
        ...
        {/* ── Resume Repository (live) ───────────────────────────── */}
        <CvUploadCard initialCvPath={profile?.cv_url ?? null} />
